...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateUI() {
        Log.i("MAIN UPDATEUI", "Running UpdateUI");

        //  Load instance of global variables
        Globals globalVars = Globals.getInstance();
        Boolean practice = globalVars.getPractice();
        ...
        if (practice == true) {
            ...
            masterIndex = masterIndex * 5;

        } else {
            masterIndex = globalVars.getMasterIndex();                          //  Master index number
        }


        Integer randomIndex = globalVars.getRandomOrderElement(masterIndex);        //  Random row of dimensions to choose
        Double imgDim = globalVars.getFullDataArrayElement(randomIndex, 0);         //  Dimension of visual button
        globalVars.setImgDim(imgDim.intValue());
        ...
        globalVars.setDelegateDim(delegateDim.intValue());
        ...
        globalVars.setSquareDim(centerFrameDim.intValue());
        ...
        Integer activeButton = globalVars.getActiveButton(masterIndex);             //  Which button should be active
        globalVars.setActiveButton(activeButton);
        ...
        globalVars.setDimensions("squareView dim: " + Math.round(centerFrameDim) +
                ...
                "\tactiveButton\t" + activeButton + "\tspaceDim\t" + spaceDim + "\tmasterIndex\t" + masterIndex);

        //  Update the view parameters
        Log.i("MAIN UPDATEUI", "Updating Dims");
        ...
        Log.i("MAIN UPDATEUI", "Changing active button color");
        ...
        Log.i("MAIN UPDATEUI", "Setting Delegates");

        //  Create larger touch targets
        setDelegates(delegateDimPX);

        globalVars.addToIndex();
        Log.i("MAIN UPDATEUI", "Increasing Main Index to: " + masterIndex);
    ...
    public void setDelegates(Double delegateDim) {
        ...
        Log.i("MAIN UPDATEUI", "Finishing Delegates");
